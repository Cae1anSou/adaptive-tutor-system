...
def main():
    ...
    output_lines.append(f"SUS - U = {test_results['sus']['mann_whitney_u']['statistic']:.3f}, p = {test_results['sus']['mann_whitney_u']['p_value']:.3f}")
    output_lines.append(f"NASA-TLX (Unweighted) - U = {test_results['nasa_unweighted']['mann_whitney_u']['statistic']:.3f}, p = {test_results['nasa_unweighted']['mann_whitney_u']['p_value']:.3f}")
    # output_lines.append(f"NASA-TLX (Weighted) - U = {test_results['nasa_weighted']['mann_whitney_u']['statistic']:.3f}, p = {test_results['nasa_weighted']['mann_whitney_u']['p_value']:.3f}")
    # output_lines.append(f"CPES - U = {test_results['cpes']['mann_whitney_u']['statistic']:.3f}, p = {test_results['cpes']['mann_whitney_u']['p_value']:.3f}")
